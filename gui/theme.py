"""
Cyberpunk/Terminal theme for the EXE Sandbox GUI.
This module defines the complete QSS stylesheet that gives the application
its hyper-styled, neon-accented, dark terminal aesthetic.

The color palette is inspired by cyberpunk aesthetics:
...
def get_stylesheet() -> str:
    """
    Get the complete cyberpunk stylesheet.
